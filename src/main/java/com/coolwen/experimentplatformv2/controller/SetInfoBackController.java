 ...
 */
@Controller
@RequestMapping(value = "/setinfoback")
public class SetInfoBackController {

    protected static final Logger logger = LoggerFactory.getLogger(SetInfoBackController.class);
    @Autowired
