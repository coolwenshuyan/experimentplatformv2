...
public interface TotalScoreCurrentRepository extends BaseRepository<TotalScoreCurrent, Integer>, JpaSpecificationExecutor<TotalScoreCurrent> {
    ...
    @Query("select new com.coolwen.experimentplatformv2.model.DTO.ModuleGradesDto(t3.m_id,t3.m_name,t1.mTestScore,t2.m_test_baifenbi,t1.mReportScore,t2.m_report_baifenbi,t1.mScore) from KaoheModel t2 left join ExpModel t3 on t2.m_id=t3.m_id left join KaoHeModelScore t1 on t2.id= t1.tKaohemodleId where t1.stuId = ?1")
